<template>
    <div id="app">
        ...
        <form @submit.prevent="addTown">
            ...
            <span :style="{'color': errors.has('alpha_field') ? 'red' : 'green'}" v-show="errors.has('alpha_field')">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            graphQlPromise('http://localhost:4000/graphql', '{ hello }').then(r => this.by = r.hello);
            graphQlPromise('http://localhost:4000/graphql', '{ me { towns } }').then(r => this.towns = r.me.towns);
        }
    }
</script>
